...
class TradingStrategy:
    ...
    def run_bnb_long(self):
        try:
            subprocess.Popen(["python", "fil_long.py"])
            print("Running fil_long.py")
        except Exception as e:
            print(f"Error running fil_long.py: {e}")

    def run_bnb_short(self):
        try:
            subprocess.Popen(["python", "fil_short.py"])
            print("Running fil_short.py")
        except Exception as e:
            print(f"Error running fil_short.py: {e}")
